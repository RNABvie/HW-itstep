...
class Post(models.Model):
    ...
    description = models.TextField(verbose_name="Описание", max_length=3500)
    image = models.ImageField(verbose_name="Изображение", upload_to="static/images/products", default="static/images/products/defPostImg.png", null=True, blank=True)
